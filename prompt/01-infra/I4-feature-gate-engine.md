...
Implement data-driven feature gating for WA agent limit, calendar access, lead limit, and tenant automation status.

## Scope

- Keep controllers thin
- Put business logic in services/actions
- Tenant isolation required
- No conversation/AI behavior implementation
...
- Happy path
- Forbidden/expired/invalid path
- Tenant isolation
- Role permission

## Exit Criteria

Feature works independently with tests passing.
