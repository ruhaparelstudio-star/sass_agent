...
Block price/package/file/calendar/invoice claims without grounded source.
...
- Return explicit pass/block reasons
...
- Allow safe action
- Store/return reason
- Tenant policy respected

## Exit Criteria

Validator can be used by pipeline with deterministic pass/block output.
