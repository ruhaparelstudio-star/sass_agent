...
Show lead, state, summary, reason, and recommended next action.

## Scope

- UI/controller only where needed
- Controllers thin
- No engine business logic in UI
...
- Authorized tenant admin can access
- Cross-tenant access forbidden
- State transition works through service
- UI displays expected data

## Exit Criteria

Admin UI feature works without duplicating business logic.
