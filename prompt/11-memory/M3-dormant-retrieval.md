...
Implement dormant retrieval only on explicit trigger.

## Scope

- Do not auto-load dormant memory
- No LLM final authority
- Respect retention_until
- Keep memory tenant-scoped
...
- Dormant memory not loaded by default
- Dormant loads on explicit trigger
- Expired retention ignored

## Exit Criteria

Memory behavior follows PRD safety rules.
