...
Match package/service aliases from tenant knowledge dynamically. No hardcoded wedding package names.

## Scope

- No final action decision
- No outbound sending
- No validator bypass
...
- Valid classification/extraction
- Invalid JSON fallback
- Unknown package not hallucinated
- Tenant-specific aliases resolved only from tenant data

## Exit Criteria

AI layer produces stable interpretation contracts only.
