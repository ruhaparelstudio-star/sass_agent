...
Implement tenant-aware calendar availability service and disabled/error fallback.

## Scope

- Tenant-aware only
- Safe fallback on external error
- No availability claim without calendar result
- No invoice send beyond max count
...
- Disabled integration fallback
- Error fallback
- Permission/block rules
- Tenant isolation

## Exit Criteria

Integration works safely and never fabricates state.
