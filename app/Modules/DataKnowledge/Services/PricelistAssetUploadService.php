...
class PricelistAssetUploadService
{
    public function uploadPricelistPdf(
        int $tenantId,
        int $ownerTenantId,
        UploadedFile $file,
        ...
        $baseDir = trim((string) config('dataknowledge.assets.pricelist_dir', 'tenant-assets/pricelist'), '/');
