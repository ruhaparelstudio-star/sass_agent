...
class WaSyncServiceTest extends TestCase
{
    ...
    public function test_account_transition_rules_are_enforced(): void
    {
        ...
        $this->assertTrue($service->canTransitionAccountStatus(WaAccountStatus::Connected, WaAccountStatus::Connecting));
    }
    ...
    public function test_session_transition_rules_are_enforced(): void
    {
        ...
        $this->assertTrue($service->canTransitionSessionStatus(WaSessionStatus::Closed, WaSessionStatus::Active));
    }
